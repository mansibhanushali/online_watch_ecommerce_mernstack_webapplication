      ...
      >
        ...
        <div className='flex flex-col gap-2'>
          ...
          <textarea
            ...
            required
            className='bg-[#d9ad75] border-2 border-black rounded-lg px-4 py-3 h-24 placeholder:text-white'
          />
        </div>
        ...
        <div className='flex flex-col md:flex-row gap-6'>
          <div className='flex flex-col gap-2'>
            ...
            <select
              ...
              className='bg-[#d9ad75] border-2 border-black rounded-lg px-4 py-2'
            >
