      ...
      <div className='w-full mt-[90px] px-4 py-8 flex flex-col items-center gap-[30px]'>
        ...
        {list?.length > 0 ? (
          list.map((item, index) => (
            <div
              key={index}
              className='w-full max-w-[800px] md:h-auto bg-[#e1o095] rounded-xl flex flex-col md:flex-row items-center justify-start gap-[10px] md:gap-[30px] p-[10px] md:px-[30px] border-2 border-[black]'
            >
              <img 
                src={item.image} 
                alt={item.name} 
