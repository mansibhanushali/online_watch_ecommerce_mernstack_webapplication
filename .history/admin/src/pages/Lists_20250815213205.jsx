      ...
      <div className='w-full mt-[90px] px-4 py-8 flex flex-col items-center gap-[30px]'>
        ...
        {list?.length > 0 ? (
          list.map((item, index) => (
            <div
              key={index}
              className='w-full max-w-[800px] md:h-auto bg-slate-600 rounded-xl flex flex-col md:flex-row items-center justify-start gap-[10px] md:gap-[30px] p-[10px] md:px-[30px] border-2 border-[black]'
            >
              <img 
                src={item.image} 
                alt={item.name} 
              ...
              <div className='flex gap-2 flex-col md:flex-row'>
                {editingId === item._id ? (
                  <button
                    ...
                    className='text-black bg-green-600 hover:bg-green-400 px-3 py-1 rounded-md text-sm md:text-base'
                  >
                    Save
                  </button>
                ) : (
                  <button
                    ...
                    className='text-black bg-yellow-500 hover:bg-yellow-300 px-3 py-1 rounded-md text-sm md:text-base'
                  >
                    Edit
                  </button>
                )}
                <button
                  ...
                  className='text-black bg-red-600 hover:bg-red-400 px-3 py-1 rounded-md text-sm md:text-base'
                >
                  Remove
                </button>
              </div>
