...
function Login() {
  ...
  const { serverUrl } = useContext(authDataContext); // ✅ get backend URL
  ...
  const AdminLogin = async (e) => {
    ...
    try {
      const result = await axios.post(
        `${serverUrl}/api/auth/adminlogin, // ✅ always point to backend
        { email, password },
  ...
  return (
    <div className="w-screen h-screen bg-gradient-to-br from-[#0f0f0f] via-[#1f2d2f] to-[#162729] text-white flex items-center justify-center px-4">
