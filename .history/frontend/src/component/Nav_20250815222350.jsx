...
function Nav() {
  ...
  return (
    ...
    >
      ...
      {showSearch && (
        <div className='w-[100%]  h-[80px] bg-[burlywood] absolute top-[100%] left-0 right-0 flex items-center justify-center border-2 border-black'>
          <input type="text" className='lg:w-[50%] w-[80%] h-[60%] bg-[burlywood] rounded-[30px] px-[50px] placeholder:text-white text-[white] text-[18px]' placeholder='Search Here' onChange={(e) => { setSearch(e.target.value) }} value={search} />
        </div>
      )}
