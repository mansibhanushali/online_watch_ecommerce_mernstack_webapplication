...
function ProductDetail() {
  ...
  return productData ? (
    <div className='min-h-screen flex flex-col md:flex-row gap-8 bg-[#d9ad75] p-4 md:p-16 text-black'>
      ...
      <div className='w-full md:w-[50%] flex flex-col gap-6'>
        ...
        <button
          ...
          className='mt-6 bg-[#d9ad75] text-black px-6 py-3 rounded hover:opacity-90'
        >
          Add to Cart
        </button>
      </div>
