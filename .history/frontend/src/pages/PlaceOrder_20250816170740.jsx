      ...
      <div className='lg:w-[50%] w-[100%] h-[100%] flex items-center justify-center mt-[90px]'>
        <form onSubmit={onSubmitHandler} className='lg:w-[70%] w-[95%]'>
          ...
          <div className='flex gap-2 px-[10px] mb-4'>
            <input type="text" placeholder='First name' className='w-1/2 h-[50px] bg-slate-700 text-black px-4 rounded-md' required onChange={onChangeHandler} name='firstName' value={formData.firstName} />
            <input type="text" placeholder='Last name' className='w-1/2 h-[50px] bg-slate-700 text-black px-4 rounded-md' required onChange={onChangeHandler} name='lastName' value={formData.lastName} />
          </div>
