        ...
        <form onSubmit={handleLogin} className='w-[90%] flex flex-col items-center gap-[20px]'>
          <div className='w-full flex flex-col gap-[15px] relative'>
            ...
            <button
              type="submit"
              disabled={loading}
              className='w-full h-[50px] bg-[burlywood] rounded-lg mt-[20px] flex items-center justify-center text-[17px] font-semibold border-2 border-[black]'
            >
            ...
            <p className='flex gap-[10px] text-sm'>
              ...
              <span
                className='text-[#39270f] text-[17px] font-semibold cursor-pointer'
