            ...
            <div key={index} className='w-[100%] h-[10%] border-t border-b'>
              <div className='w-[100%] h-[80%] flex items-start gap-6 bg-[burlywood] py-[10px] px-[20px] rounded-2xl relative'>
                ...
                <input
                  ...
                  className='md:max-w-20 max-w-10 md:px-2 md:py-2 py-[5px] px-[10px] text-[black] text-[18px] font-semibold bg-[#d9ad75] absolute md:top-[40%] top-[46%] left-[75%] md:left-[50%] border-[1px] border-[#9ff9f9] rounded-md'
                  onChange={(e) => {
