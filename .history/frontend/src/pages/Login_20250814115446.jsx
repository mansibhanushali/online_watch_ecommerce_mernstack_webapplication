...
function Login() {
  ...
  const { serverUrl, login } = useContext(authDataContext); // 👈 login function from AuthContext
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // ✅ Save in AuthContext (this will also save in localStorage via context effect)
      login({ token, user });
    ...
    <div className='w-[100vw] h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] text-white flex flex-col items-center justify-start'>
      ...
      <div className='max-w-[600px] w-[90%] h-[400px] bg-[#00000025] border border-[#96969635] backdrop:blur-2xl rounded-lg shadow-lg flex items-center justify-center'>
        <form
          ...
          className='w-[90%] flex flex-col items-center justify-start gap-[20px]'
        >
