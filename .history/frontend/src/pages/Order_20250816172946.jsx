            ...
            <div className="flex items-start gap-6 bg-[#d9ad75] py-[10px] px-[20px] rounded-2xl relative">
              ...
              <div className="flex flex-col gap-[5px]">
                ...
                <div className="flex gap-3 mt-2">
                  <button
                    className="px-3 py-1 rounded-md bg-[burlywood] text-[black] text-sm active:bg-slate-500"
                  ...
                  <button
                    ...
                    className={`px-3 py-1 rounded ${
                      item.status === "pending" ? "bg-[#d9ad75]" : "bg-[#d9ad75] cursor-not-allowed border border-[black]"
                    }`}
