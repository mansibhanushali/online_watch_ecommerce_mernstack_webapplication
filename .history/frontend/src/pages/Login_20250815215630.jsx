...
function Login() {
  ...
  return (
    <div className='w-[100vw] h-[100vh] bg-gradient-to-l from-[burlwood] to-[burlywood] text-black flex flex-col items-center justify-start'>
      ...
      {/* Form */}
      <div className='max-w-[600px] w-[90%] h-[400px] bg-[#00000025] border-2 border-[black] rounded-lg shadow-lg flex items-center justify-center'>
        <form onSubmit={handleLogin} className='w-[90%] flex flex-col items-center gap-[20px]'>
          <div className='w-full flex flex-col gap-[15px] relative'>
            <input
              type="email"
              className='w-full h-[50px] border-[2px] border-[#96969635] rounded-lg shadow-lg bg-transparent placeholder-[#ffffffc7] px-[20px] font-semibold'
              placeholder='Email'
              required
              value={email}
